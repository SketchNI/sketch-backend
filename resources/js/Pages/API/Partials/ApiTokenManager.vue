            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    <div class="input-group">
                        <jet-input name="name" label="API Token Name" v-model="createApiTokenForm.name"
                                   :autofocus="true"/>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center justify-between" v-for="token in tokens" :key="token.id">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <button class="cursor-pointer ml-6 text-sm text-gray-300 underline"
...
<style scoped>
.input-group {
    @apply border border-gray-700 bg-gray-900 rounded-md px-3 py-2 shadow-sm;
