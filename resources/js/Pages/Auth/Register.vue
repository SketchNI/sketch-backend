    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the <a target="_blank" :href="route('terms.show')"
                                              class="underline text-sm text-zinc-600 hover:text-zinc-900">Terms of
                            Service</a> and <a target="_blank" :href="route('policy.show')"
                                               class="underline text-sm text-zinc-600 hover:text-zinc-900">Privacy
                            Policy</a>
                        </div>
                    </div>
                </jet-label>
            ...
            <div class="flex items-center justify-end mt-4">
                <x-link :href="route('login')" class="underline text-sm text-zinc-600 hover:text-zinc-900">
                    Already registered?
                </x-link>
